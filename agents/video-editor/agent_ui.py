...
def prepare():
    # The Agent remains usable without FFmpeg: it can inspect a request and
    # return the source preview. FFmpeg enables export of explicit trims.
...
def create_ui():
    return tk.Interface(
        fn=edit_video,
        inputs=[{
            "main": tk.Text("剪辑要求", placeholder="例如：保留开头 10–45 秒；删掉中间停顿；做成 30 秒短视频"),
