...
export const initialPlugins: ModelPlugin[] = [
  {
    ...
    author: 'hexgrad',
    engineAuthor: 'k2-fsa',
    description: '通过 sherpa-onnx 本地合成中英文语音，内置 103 个说话人。',
    capabilities: ['TTS', '中文', '英文'],
  ...
  },
  {
    ...
    author: 'CEVA',
    engineAuthor: 'k2-fsa',
    description: '通过 sherpa-onnx 进行 48 kHz 单声道或立体声语音增强。',
    capabilities: ['AI 降噪', '48 kHz', '文件处理'],
  ...
  },
  {
    ...
    author: 'FunAudioLLM',
    engineAuthor: 'k2-fsa',
    description: '中英日韩粤语本地识别，独立输出文本与 Token 时间戳。',
    capabilities: ['ASR', '时间戳', '多语言'],
