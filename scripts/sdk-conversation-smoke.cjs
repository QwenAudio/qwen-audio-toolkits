...
class E { constructor(tag='div'){this.tag=tag;this.dataset={};this.children=[];this.hidden=false;this.classList={add(){},remove(){},toggle(){},contains(){return true}};} append(x){this.children.push(x)} replaceChildren(){this.children=[]} addEventListener(){} setAttribute(){} querySelectorAll(){return []} querySelector(){return null} click(){this.onclick?.()} remove(){} }
